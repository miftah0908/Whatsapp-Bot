...
if (!q) return md.sendMessage(from, {text: "Tag orang yang ingin kamu demote"},{quoted: md1 })
await md.groupParticipantsUpdate(from, bot.message.extendedTextMessage.contextInfo.mentionedJid, "demote")
 
md.sendMessage(from, {text: "Sukses"},{quoted: md1 })
} catch(e) {
md.sendMessage(from, {text: "Terjadi kesalahan, coba tag orang yang ingin kamu demote"},{quoted: md1 }) }
} 
