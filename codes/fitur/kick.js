...
await md.groupParticipantsUpdate(from, bot.message.extendedTextMessage.contextInfo.mentionedJid, "remove")
md.sendMessage(from, {text: "Sukses"},{quoted: md1 })

} catch(e) {
md.sendMessage(from, {text: "Tag orang yang ingin kamu kick, Kamu bisa tag siapa pun, kecuali admin!"},{quoted: md1 }) }
} 
